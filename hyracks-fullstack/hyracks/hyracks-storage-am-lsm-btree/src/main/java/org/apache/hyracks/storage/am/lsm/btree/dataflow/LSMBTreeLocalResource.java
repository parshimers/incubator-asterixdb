...
public class LSMBTreeLocalResource extends LsmResource {
    ...
    public static IJsonSerializable fromJson(IPersistedResourceRegistry registry, JsonNode json)
        ...
        final ICompressorDecompressorFactory compressorDecompressorFactory = compressorDecompressorNode != null
                ? (ICompressorDecompressorFactory) registry.deserialize(compressorDecompressorNode) : null;
        return new LSMBTreeLocalResource(registry, json, bloomFilterKeyFields, bloomFilterFalsePositiveRate, isPrimary,
                btreeFields, compressorDecompressorFactory);
    }
