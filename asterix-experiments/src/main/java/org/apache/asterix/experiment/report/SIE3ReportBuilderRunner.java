...
public class SIE3ReportBuilderRunner {
    ...
    public SIE3ReportBuilderRunner() {
        filePath = "/Users/kisskys/workspace/asterix_experiment/run-log/result-report/";
        if (IS_PROFILE) {
            runLogFilePath = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/profile/log-1440310987963/run.log";
            sie3Dhbtree = new SIE3ReportBuilder("SpatialIndexExperiment3Dhbtree", new String(runLogFilePath));
            sie3Dhvbtree = new SIE3ReportBuilder("SpatialIndexExperiment3Dhvbtree", new String(runLogFilePath));
            sie3Rtree = new SIE3ReportBuilder("SpatialIndexExperiment3Rtree", new String(runLogFilePath));
            runLogFilePath = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/profile/log-1440397891870/run.log";
            sie3Shbtree = new SIE3ReportBuilder("SpatialIndexExperiment3Shbtree", new String(runLogFilePath));
            sie3Sif = new SIE3ReportBuilder("SpatialIndexExperiment3Sif", new String(runLogFilePath));
        } else {
            runLogFilePath = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/log-1439535531522/run.log";
            sie3Dhbtree = new SIE3ReportBuilder("SpatialIndexExperiment3Dhbtree", new String(runLogFilePath));
            sie3Dhvbtree = new SIE3ReportBuilder("SpatialIndexExperiment3Dhvbtree", new String(runLogFilePath));
            sie3Rtree = new SIE3ReportBuilder("SpatialIndexExperiment3Rtree", new String(runLogFilePath));
            sie3Shbtree = new SIE3ReportBuilder("SpatialIndexExperiment3Shbtree", new String(runLogFilePath));
        ...
        //from node1
        profileFileHomeDir = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/profile/log-1440310987963/SpatialIndexExperiment3Rtree/node1/logs/";
        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-23-00:35:50.542.txt";
        falsePositiveFilePath = profileFileHomeDir + "falsePositivePerQuery-2015-08-23-00:35:50.542.txt";
        cacheMissFilePath = profileFileHomeDir + "cacheMissPerQuery-2015-08-23-00:35:50.542.txt";
        dhbtreeProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));

        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-23-01:35:44.482.txt";
        falsePositiveFilePath = profileFileHomeDir + "falsePositivePerQuery-2015-08-23-01:35:44.482.txt";
        cacheMissFilePath = profileFileHomeDir + "cacheMissPerQuery-2015-08-23-01:35:44.482.txt";
        dhvbtreeProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));

        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-23-02:35:41.353.txt";
        falsePositiveFilePath = profileFileHomeDir + "falsePositivePerQuery-2015-08-23-02:35:41.353.txt";
        cacheMissFilePath = profileFileHomeDir + "cacheMissPerQuery-2015-08-23-02:35:41.353.txt";
        rtreeProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));

        profileFileHomeDir = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/profile/log-1440397891870/SpatialIndexExperiment3Sif/node1/logs/";
        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-24-00:42:06.829.txt";
        falsePositiveFilePath = profileFileHomeDir + "falsePositivePerQuery-2015-08-24-00:42:06.829.txt";
        cacheMissFilePath = profileFileHomeDir + "cacheMissPerQuery-2015-08-24-00:42:06.829.txt";
        shbtreeProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));

        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-24-02:01:24.509.txt";
        falsePositiveFilePath = profileFileHomeDir + "falsePositivePerQuery-2015-08-24-02:01:24.508.txt";
        cacheMissFilePath = profileFileHomeDir + "cacheMissPerQuery-2015-08-24-02:01:24.509.txt";
        sifProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));
        
        //from node2
//        profileFileHomeDir = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/profile/log-1440310987963/SpatialIndexExperiment3Rtree/node1/logs/";
//        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-23-00:35:50.542.txt";
//        falsePositiveFilePath = "/Users/kisskys/workspace/asterix_experiment/run-log/8gen-balloon-AMLSMRTree-1000squery/profile/log-1440310987963/SpatialIndexExperiment3Rtree/node2/logs/" + "falsePositivePerQuery-2015-08-23-00:36:07.102.txt";
//        cacheMissFilePath = profileFileHomeDir + "cacheMissPerQuery-2015-08-23-00:35:50.542.txt";
//        dhbtreeProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));
//
//        indexSearchTimeFilePath = profileFileHomeDir + "pidxSearchTimePerQuery-2015-08-23-01:35:44.482.txt";
...
//        sifProfiler = new ProfilerReportBuilder(new String(indexSearchTimeFilePath), new String(falsePositiveFilePath), new String(cacheMissFilePath));
    ...
    public void generateSelectQueryProfiledSidxSearchTime() throws Exception {
        ...
        FileOutputStream fos = ReportBuilderHelper.openOutputFile(filePath
    ...
    public void generateSelectQueryProfiledFalsePositive() throws Exception {
        ...
        fos.write(sb.toString().getBytes());
        ReportBuilderHelper.closeOutputFile(fos);
        generateFalsePositive(filePath
                + "sie3_select_query_profiled_false_positive_raw.txt", filePath + "sie3_select_query_result_count.txt", filePath
                + "sie3_select_query_profiled_false_positive.txt", false);
    }
    
    private void generateFalsePositive(String falsePositveFile, String queryResultCountFile, String outputFile, boolean isJoin) throws IOException {
        ...
        for (int i = 0; i < radiusCount; i++) {
            ...
            sb.append(radius[i])
                    .append(",").append(((Double.parseDouble(fps[1]) * partitionCount) - Double.parseDouble(rcs[1]))/partitionCount)
                    .append(",").append(((Double.parseDouble(fps[2]) * partitionCount) - Double.parseDouble(rcs[2]))/partitionCount)
                    .append(",").append(((Double.parseDouble(fps[3]) * partitionCount) - Double.parseDouble(rcs[3]))/partitionCount)
                    .append(",").append(((Double.parseDouble(fps[4]) * partitionCount) - Double.parseDouble(rcs[4]))/partitionCount)
                    .append(",").append(((Double.parseDouble(fps[5]) * partitionCount) - Double.parseDouble(rcs[5]))/partitionCount)
                    .append("\n");
            //false positive rate
//            sb.append(radius[i])
...
//            .append("\n");
    ...
    public void generateJoinQueryProfiledFalsePositive() throws Exception {
        ...
        generateFalsePositive(filePath
                + "sie3_join_query_profiled_false_positive_raw.txt", filePath + "sie3_join_query_result_count.txt", filePath
                + "sie3_join_query_profiled_false_positive.txt", true);
    }
