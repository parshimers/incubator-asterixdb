...
import { QueryRequest, QueryPrepare } from '../../shared/models/asterixDB.model';
...
export class InputQueryComponent {
    currentQuery = 0;
    queryString: string = "Use Metadata; select * from CompactionPolicy";
    metricsString: {};
        ...
        this.queryPrepared$.subscribe((data: any) => {
			if (data) {
                ...
                if (this.preparedQueryCount == 0) {
                    ...
                    this.queryPrepare = { editorId: String(this.currentQuery), queryString: this.queryString };
    ...
    getQueryResults(queryString: string) {
        ...
        this.queryRequest = { requestId: String(QueryOrder), queryString: queryString };
    ...
    onClickNew() {
        ...
        this.queryPrepare = { editorId: String(this.currentQuery), queryString: "" };
        this.store.dispatch(new sqlQueryActions.PrepareQuery(this.queryPrepare));
    ...
    onClickClear() {
        let queryClear = { editorId: String(this.currentQuery), queryString: "" };
