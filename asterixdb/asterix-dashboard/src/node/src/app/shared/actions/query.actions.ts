...
import { AsterixDBQueryMessage, QueryRequest, QueryPrepare, QueryClean } from '../models/asterixDB.model';
...
export class PrepareQuery implements Action {
    ...
    constructor(public payload: QueryPrepare) {} // string the AsterixDB Query String
}
...
export class CleanQuery implements Action {
    ...
    constructor(public payload: QueryClean) {} // string the AsterixDB Query String
}
...
export class ExecuteQuery implements Action {
    ...
    constructor(public payload: QueryRequest) {} // string the AsterixDB Query String
}
