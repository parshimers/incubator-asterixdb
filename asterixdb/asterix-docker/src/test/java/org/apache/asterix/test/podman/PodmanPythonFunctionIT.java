...
public class PodmanPythonFunctionIT {
    ...
    @ClassRule
    public static GenericContainer<?> asterix = new GenericContainer(ASTERIX_IMAGE).withExposedPorts(19004,5006,19002).withFileSystemBind("../asterix-app/","/var/tmp/asterix-app/", BindMode.READ_WRITE);
    ...
    public static void setUp() throws Exception {
        final TestExecutor testExecutor = new TestExecutor(List.of(InetSocketAddress.createUnresolved(asterix.getHost(), asterix.getMappedPort(19002))));
