...
public interface ILogRecord {
    ...
    int UPDATE_LOG_BASE_SIZE = ENTITY_COMMIT_LOG_BASE_SIZE + UPDATE_LSN_HEADER + UPDATE_BODY_HEADER + CHKSUM_LEN;
    int FILTER_LOG_BASE_SIZE = ALL_RECORD_HEADER_LEN + FILTER_UPDATE_HEADER_LEN + UPDATE_BODY_HEADER + CHKSUM_LEN;
