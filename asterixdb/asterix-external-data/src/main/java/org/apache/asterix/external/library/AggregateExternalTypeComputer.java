...
public class AggregateExternalTypeComputer extends AbstractResultTypeComputer {
    ...
    public AggregateExternalTypeComputer(IAType resultPrimeType, List<IAType> paramPrimeTypes, boolean nullCall) {
