...
public class ExperimentAdmTupleParser extends AdmTupleParser {
    ...
    public ExperimentAdmTupleParser(IHyracksTaskContext ctx, ARecordType recType, boolean isPKAutoGenerated, int primaryKeyPosition, long duration, long pollFrequency)
            throws HyracksDataException {
        super(ctx, recType, isPKAutoGenerated, primaryKeyPosition, recType);
