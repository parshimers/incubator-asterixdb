...
public class SpatialIndexEvaluatorForSyntheticDataQueryOnly {
    ...
    private static void runQuery(String indexType, int runCount) throws URISyntaxException, IOException {
        ...
        try {
            for (int i = 0; i < numQuery; i++) {
                ...
                if (isJoin) {
                    ahc.prepareQuery(getJoinQueryAQL());
                } else {
                    ahc.prepareQuery(getSelectQueryAQL());
                }
                sw.start();
    ...
    private static String getSelectQueryAQL() {
        ...
        sb.append("count( ");
        sb.append("for $x in dataset " + datasetName).append(" ");
    ...
    private static String getJoinQueryAQL() {
        Double radius = circleRadius;
        ...
        */
        ...
        sb.append(" use dataverse STBench; \n");
        sb.append(" count( \n");
        sb.append(" for $x in dataset FsqVenue").append(" \n");
        sb.append(" let $area := create-circle($x.coordinates, ").append(String.format("%f", radius)).append(" ) \n");
        sb.append(" for $y in dataset " + datasetName).append(" \n");
