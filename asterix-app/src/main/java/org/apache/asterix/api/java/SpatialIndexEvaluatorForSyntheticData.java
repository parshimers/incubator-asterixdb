...
public class SpatialIndexEvaluatorForSyntheticData {
    ...
    private static int coordRectangleIdx = numQuery / 2;
    ...
    private static String getLoadAQL() {
        return "use dataverse STBench; " + "load dataset " + datasetName + " using "
                + "\"org.apache.asterix.external.dataset.adapter.NCFileSystemAdapter\"" + "((\"path\"=\"" + ipAddress
                + ":///" + admFilePath + "\"),(\"format\"=\"adm\"));";
    }
