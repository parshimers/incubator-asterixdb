...
public class StaticHilbertBTreeBinaryTokenizerFactory extends SpatialCellBinaryTokenizerFactory {
    private static final long serialVersionUID = 1L;

    public StaticHilbertBTreeBinaryTokenizerFactory(double bottomLeftX, double bottomLeftY, double topRightX,
    ...
    public IBinaryTokenizer createTokenizer() {
        return new StaticHilbertBTreeBinaryTokenizer(bottomLeftX, bottomLeftY, topRightX, topRightY, levelDensity,
