...
public final class MetadataRecordTypes {
    ...
    public static final int FEED_POLICY_ARECORD_POLICY_DEFINITION_FIELD_INDEX = 2;
    ...
    private static ARecordType createFeedPolicyRecordType() throws AsterixException {
        ...
        String[] fieldNames = { "DataverseName", "PolicyName", "Definition", "Properties" };
    ...
    private static final ARecordType createPrimaryFeedDetailsRecordType() throws AsterixException {
